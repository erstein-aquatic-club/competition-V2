        ...
        <div className="mt-4 rounded-3xl border border-border bg-card overflow-hidden">
          ...
          <div className="border-b border-border/70 bg-muted/20 px-3 py-2 sm:px-5">
            <div className="flex flex-wrap items-center gap-2 text-[11px] font-medium text-muted-foreground">
              <span className="rounded-md bg-muted px-1.5 py-0.5 font-bold text-foreground">M</span>
              <span>matin</span>
              <span className="rounded-md bg-muted px-1.5 py-0.5 font-bold text-foreground">S</span>
              <span>soir</span>
            ...
            <div className="mt-1 text-[11px] text-muted-foreground">
              Touchez un jour pour ouvrir directement la saisie.
            </div>
          </div>
