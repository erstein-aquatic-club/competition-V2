...
export const NEUROTYPE_QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      { label: "Oui, en permanence", scores: ["1B", "2A"] },
      { label: "Pas de façon obsessionnelle", scores: ["2B", "3"] },
      { label: "Ça dépend des périodes", scores: ["2A"] },
    ],
  },
  {
    id: 2,
    ...
    options: [
      { label: "Oui, je peux m'emporter mais ça retombe vite", scores: ["1B", "2A"] },
      { label: "Non, quand je m'énerve ça dure", scores: ["2B", "3"] },
      { label: "Ça dépend des moments", scores: ["2A"] },
    ],
  },
  {
    id: 3,
    ...
    options: [
      { label: "Les objectifs précis", scores: ["1A", "1B", "2A"] },
      { label: "Les progrès graduels", scores: ["3"] },
      { label: "Un mélange des deux", scores: ["2A"] },
    ],
  },
  {
    id: 4,
    ...
    options: [
      { label: "Quand les enjeux sont élevés", scores: ["1A", "1B"] },
      { label: "Quand la pression est faible", scores: ["2B", "3"] },
      { label: "Entre les deux", scores: ["2A"] },
    ],
  },
  {
    id: 5,
    ...
    options: [
      { label: "Pas du tout, j'aime les bousculer", scores: ["1A", "1B"] },
      { label: "Oui, je les respecte", scores: ["2B", "3"] },
      { label: "Ça dépend des situations", scores: ["2A"] },
    ],
  },
  {
    id: 6,
    ...
    options: [
      { label: "Court mais à fond", scores: ["1A", "1B"] },
      { label: "Longtemps à intensité modérée", scores: ["3"] },
      { label: "Un peu des deux", scores: ["2A"] },
    ],
  },
  {
    id: 7,
    ...
    options: [
      { label: "Oui, souvent", scores: ["2B"] },
      { label: "Parfois", scores: ["1B", "2A", "2B"] },
      { label: "Pas vraiment", scores: ["1A"] },
    ],
  },
  {
    id: 8,
    ...
    options: [
      { label: "Oui", scores: ["1B", "2A"] },
      { label: "Un peu", scores: ["2A"] },
      { label: "Pas vraiment", scores: ["1A", "2B", "3"] },
    ],
  },
  {
    id: 9,
  ...
  },
  {
    ...
    options: [
      { label: "Oui", scores: ["1B", "2A", "2B"] },
      { label: "Un peu", scores: ["2A", "2B"] },
      { label: "Pas vraiment", scores: ["1A", "1B", "3"] },
    ],
  },
  {
    id: 12,
  ...
  },
  {
    ...
    options: [
      { label: "Oui, tout le temps", scores: ["1B", "2A", "2B"] },
      { label: "Parfois", scores: ["2A"] },
      { label: "Jamais", scores: ["3"] },
    ],
  },
  {
    id: 15,
    ...
    options: [
      { label: "Oui", scores: ["2A", "2B"] },
      { label: "Un peu", scores: ["1B", "2A", "2B"] },
      { label: "Pas du tout", scores: ["1A", "1B"] },
    ],
  },
  {
    id: 16,
    ...
    options: [
      { label: "Oui, c'est indispensable", scores: ["1B", "2A", "2B"] },
      { label: "Un peu", scores: ["1B", "2A"] },
      { label: "Non, je préfère la régularité", scores: ["1A", "2B", "3"] },
    ],
  },
  {
    id: 17,
    ...
    options: [
      { label: "J'ai beaucoup d'amis", scores: ["2A"] },
      { label: "Peu d'amis, mais très proches", scores: ["1A", "2B", "3"] },
      { label: "Un mélange des deux", scores: ["1B", "2A"] },
    ],
  },
  {
    id: 18,
    ...
    options: [
      { label: "Oui, j'adore sentir que ça brûle", scores: ["2B"] },
      { label: "Non, je suis motivé(e) par autre chose", scores: ["1A", "2B", "3"] },
    ],
  },
  {
    id: 19,
    ...
    options: [
      { label: "Oui", scores: ["2A", "2B"] },
      { label: "Parfois", scores: ["1B", "2A"] },
      { label: "Pas spécialement", scores: ["1A", "2B", "3"] },
    ],
  },
  {
    id: 20,
    ...
    options: [
      { label: "Oui", scores: ["3"] },
      { label: "Un peu", scores: ["2B", "3"] },
      { label: "Pas vraiment", scores: ["1B", "2A"] },
    ],
  },
  {
    id: 21,
    ...
    options: [
      { label: "Oui", scores: ["2B", "3"] },
      { label: "Parfois", scores: [] },
      { label: "Non, je suis plutôt spontané(e)", scores: ["1B", "2A"] },
    ],
  },
  {
    id: 22,
  ...
  },
  {
    ...
    options: [
      { label: "Gagner", scores: ["1A", "1B", "2A", "2B"] },
      { label: "Impressionner et gagner le respect", scores: ["1A", "1B", "2A", "2B"] },
      { label: "Un mélange des deux", scores: ["1B", "2A"] },
    ],
  },
  {
    ...
    options: [
      { label: "Oui, c'est tout moi", scores: ["1A", "2A", "2B"] },
      { label: "Pas vraiment", scores: ["1A", "1B", "2A", "2B"] },
    ],
  },
  {
    id: 25,
    ...
    options: [
      { label: "Oui, carrément", scores: ["1A", "2A", "2B"] },
      { label: "Parfois, pour rigoler", scores: ["1B", "2A"] },
      { label: "Pas vraiment", scores: ["1A", "1B", "2A", "2B", "3"] },
    ],
  },
  {
    id: 26,
    ...
    options: [
      { label: "Courts", scores: ["1A", "1B", "2A", "2B", "3"] },
      { label: "Longs", scores: ["1A", "1B", "2A", "2B", "3"] },
    ],
  },
  {
    id: 27,
    ...
    options: [
      { label: "Fort dès le départ", scores: ["1A", "1B", "2A", "2B", "3"] },
      { label: "Je monte en puissance et je suis meilleur vers la fin", scores: ["1A", "1B", "2A", "2B", "3"] },
    ],
  },
  {
    id: 28,
    ...
    options: [
      { label: "J'ai besoin de changement pour rester motivé(e)", scores: ["1A", "1B", "2A", "2B", "3"] },
      { label: "Je n'aime pas trop que ça change", scores: ["1A", "1B", "2B", "3"] },
    ],
  },
  {
    id: 29,
    ...
    options: [
      { label: "Oui, j'ai besoin de varier", scores: ["1A", "1B", "2A", "2B", "3"] },
      { label: "Non, j'aime la répétition", scores: ["1A", "1B", "2B", "3"] },
    ],
  },
  {
    id: 30,
    ...
    options: [
      { label: "Oui", scores: ["1A", "2B", "3"] },
      { label: "Ça ne me dérange pas", scores: ["1A", "1B"] },
    ],
  },
];
